...
if __name__ == "__main__":
    ...
    for i in epochs:
        for beta in betas:
            single_run(running_env, 'RR_AU', step_size=step_size, batch_size=32, num_replay=[10, 0], beta=beta, epoch=i)
            single_run(running_env, 'RR_AU', step_size=step_size, batch_size=32, num_replay=[20, 0], beta=beta, epoch=i)
            single_run(running_env, 'RR_AU', step_size=step_size, batch_size=32, num_replay=[50, 0], beta=beta, epoch=i)
